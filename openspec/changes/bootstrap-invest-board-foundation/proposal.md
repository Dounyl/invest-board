...
- Affected code: `config/`, `data/`, `sql/`, `scripts/`, `web/`, `.github/workflows/`。
- Affected docs: `README.md`, `AGENTS.md`, `.gitignore`。
- Systems: OpenSpec 变更工作流（proposal/design/specs/tasks）与后续 GitHub Actions 自动化。
- Dependencies: 后续实现阶段将引入 Python 依赖、DuckDB、前端依赖（Vite/Vue/ECharts）。
